...
# Build a logistic regression classifier to recognize  cats with a Neural Network mindset, and so will also hone your intuitions about deep learning.
# #############################
# coding: utf-8
...
# 
# **Key steps**:
# In this code, we will carry out the following steps: 

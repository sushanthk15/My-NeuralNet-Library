...
2. Ensure that the dataset text file "Bigoni_yield_data.txt", UsingFFNET.py are located in the same directory.
...
conec = mlgraph((2,10,10,10,1))
#Expected R^2 score = 0.98
